...
export const KnowledgeBaseConversation = async (input: string, topics: string, vectorStores: string[]) => {
  ...
  const knowledgeLib: string[] = vectorStores;
  ...
  const chatPrompt = ChatPromptTemplate.fromPromptMessages([
    SystemMessagePromptTemplate.fromTemplate(
      `You are helpful assistant. You should follow the following rules when give response:
